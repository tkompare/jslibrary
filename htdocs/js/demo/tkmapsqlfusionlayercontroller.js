...
$(document).ready(function() {
	...
	var TreeTrimLayer = new TkMapSqlFusionLayer(true,Map.map,'3676987','Latitude,Longitude','StreetAddress,ServiceRequestNumber,Status,CreationDate,CompletionDate');
